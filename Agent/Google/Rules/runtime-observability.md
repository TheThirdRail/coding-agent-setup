...
Use this rule when implementing or reviewing runtime behavior, API errors, logs, or release readiness.
...
- Use structured logs when the project already supports them.
