...
Use this rule when work creates durable project context that future agents or humans need.
...
- Do not archive credentials, secrets, tokens, private environment values, or sensitive personal data.
